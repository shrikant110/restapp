...
import com.cardreader.config.filter.TransactionFilter;
import com.cardreader.services.AppUserDetailsService;
		...
		.csrf()
	 	.disable() 
		     ...
		     .authorizeRequests() 
			      ...
			      .antMatchers("/stockmaster/**").permitAll()
			      .antMatchers("/fundmaster/**").permitAll()
			      .antMatchers("/test/**").permitAll()
			      .antMatchers("/account/activateUser").permitAll()
